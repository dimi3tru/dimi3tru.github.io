...
**Sber** – *B2C, Multi-Agent AI Digital Assistant* (Moscow, Russia)
***AI Product Lead*** (May 2026 – Present)

* Реорганизовал команду с 15 до 10 специалистов, восстановив стабильное выполнение целей;
* Обеспечил стабильный и быстрый delivery продукта за счёт управления межкомандными зависимостями;
* Устранил критические проблемы core-логики AI-ассистента, снизив число продуктовых и технических инцидентов с 4 до 0,5 в квартал;
* Доработал архитектуру мультиагентной системы (FIPA ACL), достигнув 94% качества роутинга на доменных и продуктовых агентов и 89% GCR (Goal Completion Rate);
* Определяю приоритеты развития продукта: формирую краткосрочный roadmap, инициирую продуктовые и технические улучшения;
* Масштабировал AI-ассистента на 18 поверхностей экосистемы Сбера совместно со смежными командами — 13+ млн MAU.

---

**Alfabank** – *Personnel Efficiency Directorate* (Moscow, Russia)
***AI Product Lead (IC)*** (June 2025 – May 2026)
...
* Разработал MVP QMS (Quality Management System) для доставки (ИИ-аналитика диалогов сотрудников выездного канала с клиентами по телефону);
...
* Разработал и защитил перед топ-менеджментом AI стратегию развития сервиса и доставки банка.

---

**Sber** – *DTaaS, AI cluster (Digital Transformation as a Service)* (Moscow, Russia)
***Senior Data Scientist*** (September 2024 – June 2025)
...
**HSE University** – *Institute of Artificial Intelligence and Digital Sciences* (Moscow, Russia)
***Data Scientist (part-time job)*** (January 2025 – May 2025)
...
**Yandex** – *Inhouse Consulting, Ads* (Moscow, Russia)
***Data Scientist / Product Analyst*** (June 2023 – September 2024)
...
**Burger King** – *Pricing department* (Moscow, Russia)
***Data Scientist / Product Analyst*** (January 2022 – June 2023)
...
**Ozon** – *Retail department* (Moscow, Russia)
***Analyst (Intern)*** (August 2021 – January 2022)
...
**HSE University** – *Faculty of Economic Sciences* (Moscow, Russia)
***Teaching Assistant (Mathematical Analysis, Probability Theory)*** (September 2020 – June 2021)
...
* Рекомендательная система для ведущего luxury-ритейлера РФ (January – June 2025)
* MVP AI Agents системы для подбора туристических туров (April 2025)
* Антифрод модель на страховом портфеле (ML + NN) (April – May 2023)
* Разработка модели прайсинга скидок на товары Рив Гош (August – September 2022)

<hr style="border: 0; border-top: 1px solid #ccc; margin: 1em 0;">

## SKILLS

**AI:** LLM, Multi-Agent Systems, RAG, NLP, PEFT/LoRA, ML/DL, CV/VLM, PyTorch
**Tech & Data:** Python, SQL, PySpark, Git, Docker
**Product & Analytics:** AI Product Management, Product Analytics, A/B Testing, Metrics Design, BI
